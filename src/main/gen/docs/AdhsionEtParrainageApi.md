# AdhsionEtParrainageApi

All URIs are relative to *https://api.federation-agricole.mg/v1*

| Method | HTTP request | Description |
|------------- | ------------- | -------------|
| [**adhererMembre**](AdhsionEtParrainageApi.md#adhererMembre) | **POST** /membres | Adhérer à une collectivité (nouveau membre) — conditions mises à jour B-2 |
| [**changerCollectivite**](AdhsionEtParrainageApi.md#changerCollectivite) | **PUT** /membres/{id_membre}/changer-collectivite | Changer de collectivité |
| [**demissionner**](AdhsionEtParrainageApi.md#demissionner) | **POST** /membres/{id_membre}/demission | Démissionner de la collectivité actuelle |
...
import org.openapitools.client.api.AdhsionEtParrainageApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    AdhsionEtParrainageApi apiInstance = new AdhsionEtParrainageApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling AdhsionEtParrainageApi#adhererMembre");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling AdhsionEtParrainageApi#changerCollectivite");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling AdhsionEtParrainageApi#demissionner");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
